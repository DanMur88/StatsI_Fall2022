...
\begin{enumerate}
	...
	The degrees of freedom is first calculated by multiplying the number of rows minus one by the number of columns minus one, and is found to equal 2. The P-value is then calculated using the \texttt{pchisq} function. Its value is found to be approximately 0.15.
